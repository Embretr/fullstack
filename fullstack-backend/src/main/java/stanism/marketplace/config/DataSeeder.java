...
public class DataSeeder {
     ...
     * @param imageRepository repository for image data access
     * @param favoriteRepository repository for favorite data access
    ...
    private void createRandomFavoritesAndMessages() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            if (messageRepository.findBySenderAndReceiverAndItemAndContent(sender, receiver,
             item, messageContent).isPresent()) {
                continue;
            }
