...
public class ItemResponseDTO {
     ...
     */
    @Schema(description = "User who reserved the item")
     ...
     *
     * @param latitude
     *            the latitude coordinate to set
     */
     ...
     *
     * @param longitude
     *            the longitude coordinate to set
     */
    ...
    /**
     * 
     * Gets the reservation date of the item.
     *
    ...
    /**
     * Sets the reservation date of the item.
     *
     * @param reservationDate
     *            the reservation date to set
     */
    ...
    /**
     * 
     * Gets the user who reserved the item.
     *
     * @return the user who reserved the item
     */
    public UserResponse getReservedBy() {
        return reservedBy;
    }

    /**
     * Sets the user who reserved the item.
     *
     * @param reservedBy
     *            the user who reserved the item to set
     */
    public void setReservedBy(UserResponse reservedBy) {
